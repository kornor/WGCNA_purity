...
# Save the results
save(mp, file = "modulePreservation_Normals.RData");
load(file = "modulePreservation_Normals.RData")
...
write.table(pqual, "Preservation vs Quality in Normals to Consensus.txt", sep = "\t")
